...
class DrawRandomCardWidget extends StatefulWidget {
  final Session session;
  final User user;

  const DrawRandomCardWidget(
      {Key? key, required this.session, required this.user})
      : super(key: key);

  @override
  State<DrawRandomCardWidget> createState() => _DrawRandomCardWidgetState();
}

class _DrawRandomCardWidgetState extends State<DrawRandomCardWidget>
  ...
  void initState() {
    ...
    session
        .get('/api/programIdeas/group/${widget.user.actualGroupId}/forRandom')
        .then((response) {
